...
@WebListener
public class SteamServiceContextListener implements ServletContextListener {

	private static final LogUtil LOGGER = LogUtil.getLogger(SteamServiceContextListener.class);
