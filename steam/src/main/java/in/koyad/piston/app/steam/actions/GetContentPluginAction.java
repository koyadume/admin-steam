...
public class GetContentPluginAction extends PluginAction {
	
	public static final String ACTION_NAME = "getContent";
	
	private static final LogUtil LOGGER = LogUtil.getLogger(GetContentPluginAction.class);
