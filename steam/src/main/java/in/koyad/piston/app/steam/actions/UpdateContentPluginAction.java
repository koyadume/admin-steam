...
@AnnoPluginAction(
	name = UpdateContentPluginAction.ACTION_NAME
)
public class UpdateContentPluginAction extends PluginAction {
...
//		return "/pages/content.xml";
		return FrameworkConstants.PREFIX_FORWARD + GetContentPluginAction.ACTION_NAME;
	}
